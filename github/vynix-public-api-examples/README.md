...
Vynix Public API Examples is part of the [Vynix](https://vynix.in) developer toolkit. The feedback layer for teams that build with AI coding agents. This project helps you connect Vynix to your workflow so visual feedback and AI diagnosis reach your code faster.
...
Each folder is a self-contained example that calls the public Vynix API. Add your project key and run it.
