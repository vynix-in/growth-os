...
Vynix CLI is part of the [Vynix](https://vynix.in) developer toolkit. The feedback layer for teams that build with AI coding agents. This project helps you connect Vynix to your workflow so visual feedback and AI diagnosis reach your code faster.
...
Use the Vynix CLI to list feedback, create issues, and check project status from your terminal.
