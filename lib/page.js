...
import { humanizeRenderedHtml } from './humanize.js';

const NAV = [
  { label: 'Product', url: product.website },
  { label: 'Blog', url: '/blog/' },
  { label: 'Compare', url: '/compare/' },
  { label: 'Guides', url: '/best/' },
  { label: 'Use cases', url: '/for/' },
  { label: 'Help', url: '/kb/' },
];

// The real Vynix mark (nested-chevron "V"), traced from the brand artwork, so
// the static site uses the same logo as the app instead of a CSS box.
const LOGO_SVG = '<svg class="vx-logo" viewBox="0 0 1024 1024" width="28" height="28" fill="none" aria-hidden="true"><g transform="translate(0,1024) scale(0.1,-0.1)" fill="#008448"><path d="M30 8675 c0 -2 600 -532 1333 -1177 732 -645 1878 -1653 2544 -2240 l1213 -1068 1087 958 c599 526 1744 1535 2546 2240 801 706 1457 1285 1457 1288 0 2 -17 -6 -37 -19 -21 -13 -1166 -713 -2546 -1555 l-2507 -1532 -2388 1458 c-1313 803 -2458 1502 -2544 1555 -87 53 -158 95 -158 92z M1745 8503 c17 -11 783 -489 1702 -1061 l1673 -1042 1702 1061 c937 584 1694 1059 1683 1057 -11 -3 -777 -249 -1703 -548 l-1682 -543 -1683 543 c-1829 590 -1735 561 -1692 533z M1087 6789 c3048 -4001 4027 -5284 4033 -5284 9 0 4169 5458 4165 5463 -2 2 -295 -252 -652 -565 -356 -313 -1288 -1130 -2071 -1816 -783 -687 -1429 -1250 -1436 -1253 -8 -3 -239 192 -547 463 -1857 1629 -3606 3160 -3618 3168 -8 4 49 -74 126 -176z"/></g></svg>';
...
.brand{display:flex;align-items:center;gap:9px;font-weight:700;color:var(--ink);font-size:1.15rem}
.brand .vx-logo{display:block}
...
.ill-hero{margin:18px 0 26px}
.ill-hero svg{border:1px solid var(--line);border-radius:16px;box-shadow:0 8px 24px rgba(15,23,42,.06)}
...
export function header() {
  ...
  <a class="brand" href="${product.website}">${LOGO_SVG}<span class="brand-name">Vynix</span></a>
  <nav class="main">
...
export function footer() {
  ...
  <div>
    ...
    <a href="/best/">Guides</a> &middot;
    <a href="/glossary/">Glossary</a> &middot;
...
<link rel="icon" href="https://vynix.in/favicon.ico" />
<link rel="icon" type="image/svg+xml" href="https://vynix.in/favicon.svg" />
<link rel="apple-touch-icon" href="https://vynix.in/apple-touch-icon.png" />
${head}
${organizationLd()}
<style>${CSS}</style>
</head>
...
`;
  // Final safety pass: strip any machine-looking characters that slipped into
  // template literals. Safe for JSON-LD (it does not alter double quotes).
  return humanizeRenderedHtml(html);
}
