...
export const competitors = [
  ...
  { name: 'FullStory', slug: 'fullstory', category: 'Session replay', focus: 'session replay and digital experience analytics' },
  { name: 'Smartlook', slug: 'smartlook', category: 'Session replay', focus: 'session recordings and heatmaps for web and mobile' },
  { name: 'Mouseflow', slug: 'mouseflow', category: 'Product analytics', focus: 'heatmaps, session replay and funnels' },
  { name: 'Trello', slug: 'trello', category: 'Project management', focus: 'kanban boards for organising work' },
  { name: 'Asana', slug: 'asana', category: 'Project management', focus: 'work and project management for teams' },
  { name: 'ClickUp', slug: 'clickup', category: 'Project management', focus: 'an all-in-one project and task management tool' },
  { name: 'Shortcut', slug: 'shortcut', category: 'Issue tracking', focus: 'issue tracking and planning for software teams' },
  { name: 'Ruttl', slug: 'ruttl', category: 'Visual feedback', focus: 'visual website feedback and design review' },
  { name: 'Pastel', slug: 'pastel', category: 'Visual feedback', focus: 'website feedback and design review with annotations' },
  { name: 'MarkUp.io', slug: 'markup-io', category: 'Visual feedback', focus: 'visual feedback on live sites, images and PDFs' },
  { name: 'Bird Eats Bug', slug: 'bird-eats-bug', category: 'Bug reporting', focus: 'bug reports with screen recordings and technical logs' },
  { name: 'Replay.io', slug: 'replay-io', category: 'Debugging', focus: 'time-travel debugging with recordable replays' },
];
