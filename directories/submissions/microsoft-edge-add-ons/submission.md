# Submission packet — Microsoft Edge Add-ons
...
## Tags
bug-reporting, visual-feedback, website-annotation, developer-tools, ai, browser-extension, chrome-extension, productivity
