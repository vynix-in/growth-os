# Submission packet — Awesome Lists (GitHub)

Submit at: https://github.com/topics/awesome

> Free GitHub pull request: add one entry to the list and open a PR. Good fit for the Vynix MCP server.

## Product
- Name: Vynix
- Website: https://vynix.in
- Tagline: Point it. Capture it. Ship it.
- Contact: hello@vynix.in
...
- Review rounds: Group a batch of notes into a single review and let Vynix cluster them into a short list of fixes.
...
Learn more at https://vynix.in.

## Tags
bug-reporting, visual-feedback, website-annotation, developer-tools, ai, devtools, github, workflow

## Categories
Developer Tools, Bug Tracking, Productivity, AI

## Keywords
bug reporting, visual feedback, website annotation, ai diagnosis, github issues, coding agents
