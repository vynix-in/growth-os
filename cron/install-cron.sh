...
WEEKLY="0 3 * * 1 cd ${GROWTH_DIR} && ${NODE_BIN} bin/vynix-growth.js grow >> logs/cron.log 2>&1"
...
echo "  hourly  maintain (review + policy + dashboard + health)"
echo "  weekly  grow (add new content + deploy), Mondays 03:00"
