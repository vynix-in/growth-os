# Open source proposal — Vynix GitHub Action

Date: 21 June 2026
Suggested repository: https://github.com/vynix-in/vynix-github-action

## Why this is safe to publish
A GitHub Action is a thin wrapper around the public API and is most useful when public.

## How it funnels to Vynix
Every page and file in Vynix GitHub Action links back to https://vynix.in and the documentation at https://vynix.in/docs, so the open-source project funnels developers toward Vynix.
