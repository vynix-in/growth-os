# Open source proposal — Vynix Browser Extension

Date: 21 June 2026
Suggested repository: https://github.com/vynix-in/vynix-browser-extension

## Why this is safe to publish
A browser extension is client-side and already distributed to users. Open sourcing it builds trust and invites contributions without exposing the backend.

## How it funnels to Vynix
Every page and file in Vynix Browser Extension links back to https://vynix.in and the documentation at https://vynix.in/docs, so the open-source project funnels developers toward Vynix.
