# Open source proposal — Vynix Public API Examples

Date: 21 June 2026
Suggested repository: https://github.com/vynix-in/vynix-public-api-examples

## Why this is safe to publish
Examples are meant to be copied. Public examples drive adoption.

## How it funnels to Vynix
Every page and file in Vynix Public API Examples links back to https://vynix.in and the documentation at https://vynix.in/docs, so the open-source project funnels developers toward Vynix.
