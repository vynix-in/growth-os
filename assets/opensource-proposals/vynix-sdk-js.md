# Open source proposal — Vynix JavaScript SDK

Date: 21 June 2026
Suggested repository: https://github.com/vynix-in/vynix-sdk-js

## Why this is safe to publish
An SDK only wraps the public API. It contains no business logic and helps developers integrate faster.

## How it funnels to Vynix
Every page and file in Vynix JavaScript SDK links back to https://vynix.in and the documentation at https://vynix.in/docs, so the open-source project funnels developers toward Vynix.
