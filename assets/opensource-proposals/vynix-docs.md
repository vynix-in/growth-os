# Open source proposal — Vynix Developer Docs

Date: 21 June 2026
Suggested repository: https://github.com/vynix-in/vynix-docs

## Why this is safe to publish
Documentation should be public and is a strong source of search traffic.

## How it funnels to Vynix
Every page and file in Vynix Developer Docs links back to https://vynix.in and the documentation at https://vynix.in/docs, so the open-source project funnels developers toward Vynix.
