# Open source proposal — Vynix CLI

Date: 21 June 2026
Suggested repository: https://github.com/vynix-in/vynix-cli

## Why this is safe to publish
A CLI calls the public API and is a natural open-source developer tool.

## How it funnels to Vynix
Every page and file in Vynix CLI links back to https://vynix.in and the documentation at https://vynix.in/docs, so the open-source project funnels developers toward Vynix.
