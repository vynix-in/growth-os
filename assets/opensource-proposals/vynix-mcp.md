# Open source proposal — Vynix MCP Server

Date: 21 June 2026
Suggested repository: https://github.com/vynix-in/vynix-mcp

## Why this is safe to publish
An MCP server speaks to the public API over a documented protocol. It has no proprietary logic and reaches the growing agent ecosystem.

## How it funnels to Vynix
Every page and file in Vynix MCP Server links back to https://vynix.in and the documentation at https://vynix.in/docs, so the open-source project funnels developers toward Vynix.
